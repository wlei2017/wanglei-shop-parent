...
import com.demo.pay.acp.sdk.AcpService;
import com.demo.pay.acp.sdk.LogUtil;
import com.demo.pay.acp.sdk.SDKConfig;
import com.demo.pay.acp.sdk.UnionPayBase;
...
public class UnionPayStrategy implements PayStrategy {
    ...
    public String toHtml(PaymentChannelEntity paymentChannelEntity, PayMentTransacDTO payMentTransacDTO) {
        ...
        /***商户接入参数***/
        requestData.put("merId", paymentChannelEntity.getMerchantId());    	          			  //商户号码，请改成自己申请的正式商户号或者open上注册得来的777测试商户号
        requestData.put("accessType", "0");             			  //接入类型，0：直连商户
        requestData.put("orderId",payMentTransacDTO.getPaymentId());             //商户订单号，8-40位数字字母，不能含“-”或“_”，可以自行定制规则
        requestData.put("txnTime", formatDate(new Date()));        //订单发送时间，取系统时间，格式为yyyyMMddHHmmss，必须取当前时间，否则会报txnTime无效
        requestData.put("currencyCode", "156");         			  //交易币种（境内商户一般是156 人民币）
        requestData.put("txnAmt", payMentTransacDTO.getPayAmount() + "");             			      //交易金额，单位分，不要带小数点
