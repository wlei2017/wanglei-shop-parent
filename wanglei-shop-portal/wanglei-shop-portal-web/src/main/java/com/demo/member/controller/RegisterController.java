...
import com.demo.member.controller.req.vo.RegisterVo;
import com.demo.member.feign.MemberRegisterServiceFeign;
...
public class RegisterController extends BaseWebController {
	...
	public String postRegister(@ModelAttribute("registerVo") @Validated RegisterVo registerVo,
		...
		UserInpDTO userInpDTO = WangleiBeanUtils.voToDto(registerVo, UserInpDTO.class);
